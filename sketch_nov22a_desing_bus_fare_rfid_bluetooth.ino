...
char tag[] = "0200691C87F0";
char input[12];
int count = 0;
boolean flag = 0;
const int granted = 12, denied = 13;
String route1 = "NEW TEHRI-KOTI COLONY", route2 = "NEW TEHRI-BHAGIRATHIPURAM", route3 = "KOTI COLONY-NEW TEHRI";
String route4 = "KOTI COLONY-BHAGIRATHIPURAM", route5 = "BHAGIRATHIPURAM-KOTI COLONY", route6 = "BHAGIRATHIPURAM-NEW TEHRI";
String current_route,temp;
int route,route1_ticket = 60, route2_ticket = 30, route3_ticket = 60, route4_ticket = 20, route5_ticket = 20, route6_ticket = 30;
...
void setup() {
    ...
    if(digitalRead(19) ==  LOW){
      ...
      Serial.println("Card Recharged");
      Serial.print("Remaining Amount : ");
  ...
  if (rfid.available()) 
  {
    ...
    if (flag == 1) {
      if(route == 0){
        ...
        Serial.print("Ticket Rate : ");
        Serial.println(route1_ticket);
        current_route = "";
        route = 0;
      }
      else if(route == 2){
        ...
        Serial.print("Ticket Rate : ");
        Serial.println(route6_ticket);
        current_route = "";
        route = 0;
      }
      EEPROM.put(0, remaining_amount);
      Serial.print("Remaining Amount : ");
      Serial.println(remaining_amount);
